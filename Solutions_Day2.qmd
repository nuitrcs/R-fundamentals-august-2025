...
```{r}
setwd("R-fundamentals-summer-workshop")
```
...
Check that you are currently working within the `R-``fundamentals-summer-workshop` Project. If not, open the relevant .RProj file in a new RStudio session.
