...
What is the correlation coefficient between flipper length and bill length?
...
Perform a t-test to check if there is a statistically significant difference in body mass between male and female penguins. Get the p-value for this test.
